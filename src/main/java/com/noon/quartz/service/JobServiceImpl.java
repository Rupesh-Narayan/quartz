...
public class JobServiceImpl implements JobService{
	 ...
	 */
	@Override
	public boolean scheduleOneTimeJob(String jobName, Map<String, Object> payload, Class<? extends QuartzJobBean> jobClass, Date date) {
		...
		JobDetail jobDetail = JobUtil.createJob(jobClass, false, context, jobKey, groupKey, payload);
		...
		try {
			...
			qrtzAuditDao.save(jobKey, triggerKey, Constants.AUDIT_JOB_TYPE.simple, Constants.AUDIT_EVENT_TYPE.add);
			return true;
	 ...
	 */
	@Override
	public boolean scheduleCronJob(String jobName, Map<String, Object> payload, Class<? extends QuartzJobBean> jobClass, Date date, String cronExpression) {
		System.out.println("Request received to scheduleJob");
		...
		try {
			...
			Date dt = scheduler.scheduleJob(jobDetail, cronTriggerBean);
			System.out.println("Job with key jobKey : "+jobKey+ " and group : "+groupKey+ " scheduled successfully for date :"+dt);
			qrtzAuditDao.save(jobKey, triggerKey, Constants.AUDIT_JOB_TYPE.cron, Constants.AUDIT_EVENT_TYPE.add);
			return true;
		} catch (SchedulerException e) {
			System.out.println("SchedulerException while scheduling job with key :"+jobKey + " message :"+e.getMessage());
			e.printStackTrace();
	...
	public boolean updateOneTimeJob(String jobName, Date date) {
		...
		try {
			...
			qrtzAuditDao.save(jobKey, jobKey, Constants.AUDIT_JOB_TYPE.simple, Constants.AUDIT_EVENT_TYPE.update);
			return true;
		} catch ( Exception e ) {
	...
	public boolean updateCronJob(String jobName, Date date, String cronExpression) {
		...
		try {
			...
			Date dt = schedulerFactoryBean.getScheduler().rescheduleJob(TriggerKey.triggerKey(jobKey), newTrigger);
			System.out.println("Trigger associated with jobKey :"+jobKey+ " rescheduled successfully for date :"+dt);
			qrtzAuditDao.save(jobKey, jobKey, Constants.AUDIT_JOB_TYPE.cron, Constants.AUDIT_EVENT_TYPE.update);
			return true;
		} catch ( Exception e ) {
	...
	public boolean deleteJob(String jobName) {
		...
		try {
			...
			qrtzAuditDao.save(jobKey, jobKey, Constants.AUDIT_JOB_TYPE.general, Constants.AUDIT_EVENT_TYPE.delete);
			return status;
		} catch (SchedulerException e) {
	...
	public boolean pauseJob(String jobName) {
		...
		try {
			...
			qrtzAuditDao.save(jobKey, jobKey, Constants.AUDIT_JOB_TYPE.general, Constants.AUDIT_EVENT_TYPE.pause);
			return true;
		} catch (SchedulerException e) {
	...
	public boolean resumeJob(String jobName) {
		...
		try {
			...
			qrtzAuditDao.save(jobKey, jobKey, Constants.AUDIT_JOB_TYPE.general, Constants.AUDIT_EVENT_TYPE.resume);
			return true;
		} catch (SchedulerException e) {
	...
	public boolean startJobNow(String jobName) {
		...
		try {
			...
			qrtzAuditDao.save(jobKey, jobKey, Constants.AUDIT_JOB_TYPE.general, Constants.AUDIT_EVENT_TYPE.start);
			return true;
		} catch (SchedulerException e) {
	...
	public boolean stopJob(String jobName) {
		...
		try{	
			...
			qrtzAuditDao.save(jobKey, jobKey, Constants.AUDIT_JOB_TYPE.general, Constants.AUDIT_EVENT_TYPE.stop);
			return true;
		} catch (SchedulerException e) {
