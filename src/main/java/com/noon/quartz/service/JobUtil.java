...
import com.noon.quartz.config.PersistableCronTriggerFactoryBean;
...
class JobUtil {
	...
	protected static JobDetail createJob(Class<? extends QuartzJobBean> jobClass, boolean isDurable,
										 ApplicationContext context, String jobName, String jobGroup, Map<String, Object> payload){
        ...
        payload.entrySet().forEach(entry -> jobDataMap.put(entry.getKey(), entry.getValue()));
