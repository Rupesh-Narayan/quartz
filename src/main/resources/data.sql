...
----drop table if exists qrtz_CALENDERS;
--
...
--);
--
--create table if not exists qrtz_CALENDERS
--  (
--    sched_name varchar(120) not null,
...
--);
--
--create table if not exists qrtz_AUDIT
--  (
...
--    primary key (id),
--    key idx_job_name_job_type_event_type (job_name,job_type,event_type)
--);
--
